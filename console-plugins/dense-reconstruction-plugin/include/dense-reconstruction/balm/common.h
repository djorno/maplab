#ifndef BALM_COMMON_H_
#define BALM_COMMON_H_

namespace balm_error_terms {

static const int kStateSize = 16;
static const int kUpdateSize = 15;
static const int kFullResidualSize = 15;
...
static const int kFullResidualBALMOffset = 0;
static const int kFullResidualOrientationOffset = 1;
static const int kFullResidualGyroBiasOffset = 4;
static const int kFullResidualVelocityOffset = 7;
static const int kFullResidualAccelBiasOffset = 10;
static const int kFullResidualPositionOffset = 13;


static const int kErrorStateBALMBlockSize = 1;
