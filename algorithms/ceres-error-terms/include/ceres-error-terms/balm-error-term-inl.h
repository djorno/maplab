...
bool BALMErrorTerm::Evaluate(
  ...
  double coe = evaluation_callback_->get_coeff();
  Eigen::Vector3d uk = evaluation_callback_->get_uk();
  const Eigen::Vector3d& vBar = evaluation_callback_->get_vBar();

  Eigen::Matrix3d Pi = evaluation_callback_->get_sig_origin()[sig_i_].P;
  Eigen::Vector3d vi = evaluation_callback_->get_sig_origin()[sig_i_].v;
  size_t Ni = evaluation_callback_->get_sig_origin()[sig_i_].N;
  ...
  int NN = evaluation_callback_->get_NN();
